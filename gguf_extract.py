...
def extract_config(meta, arch):
    ...
    config = {
        ...
        "linear_num_value_heads": get('ssm.state_size', 32),
        "linear_num_key_heads": get('ssm.n_group', 16),
        "linear_key_head_dim": get('ssm.key_head_dim', 128),
        "linear_value_head_dim": get('ssm.value_head_dim', 128),
